...
use super::{
    account::Account,
    constants::{CEX_ADDRESSES_FILE_PATH, DB_FILE_PATH, PRIVATE_KEYS_FILE_PATH, PROXIES_FILE_PATH},
};
...
impl Database {
    ...
    pub async fn new() -> eyre::Result<Self> {
        ...
        if cex_addresses.len() != private_keys.len() {
        ...
        for (entry, cex_address) in private_keys
            .into_iter()
